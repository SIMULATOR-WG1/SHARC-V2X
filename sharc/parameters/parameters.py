...
class Parameters(object):
    ...
    def read_params(self):
        ...
        self.scm.element_max_g = config.getfloat("SCM", "element_max_g")
        self.scm.element_phi_deg_3db = config.getfloat("SCM", "element_phi_deg_3db")
        self.scm.element_theta_deg_3db = config.getfloat("SCM", "element_theta_deg_3db")
        self.scm.element_am = config.getfloat("SCM", "element_am")
        self.scm.element_sla_v = config.getfloat("SCM", "element_sla_v")
        self.scm.n_rows = config.getfloat("SCM", "n_rows")
        self.scm.n_columns = config.getfloat("SCM", "n_columns")
        self.scm.element_horiz_spacing = config.getfloat("SCM", "element_horiz_spacing")
