...
if __name__ == '__main__':
    ...
    param27.frequency = 5800
    param27.antenna_gain = 45
    param27.diameter = 3.6
    ...
    plt.semilogx(off_axis_angle_vec, gain27 - param27.antenna_gain, "-b", label = "$f = 5.8$ $GHz,$ $D = 3.6$ $m$")
