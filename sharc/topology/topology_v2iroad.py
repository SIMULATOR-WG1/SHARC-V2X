...
class TopologyV2iroad(Topology):
    ...
    def __init__(self, param: ParametersV2iroad, intersite_distance: float, num_clusters: int, tam_cluster: int):
        """
        ...
        self.intersite_distance_rsu = 1732
    ...
    def calculate_coordinates(self, random_number_gen=np.random.RandomState()):
        ...
        if self.tam_cluster == 1:
            ...
            while(not roads_validated):
                ...
                if num_loops > TopologyV2iroad.MAX_NUM_LOOPS:
...
if __name__ == '__main__':
    ...
    tam_cluster = 2
    topology = TopologyV2iroad(param, intersite_distance,num_clusters,tam_cluster)
